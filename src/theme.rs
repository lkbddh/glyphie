...
pub const EMOJI_FONT: cosmic::iced::Font = cosmic::iced::Font::with_name("Noto Color Emoji");
...
/// Secondary text in the theme's dimmed text colour for the current surface,
/// which libcosmic keeps legible on frosted (translucent) windows.
pub fn text_muted() -> cosmic::theme::Text {
    cosmic::theme::Text::Custom(|theme| cosmic::iced::widget::text::Style {
        color: Some(theme.current_container().component.on_disabled.into()),
        ..Default::default()
    })
}
