...
pub const MAX_RECENT_EMOJIS: usize = 36;
...
1. **Should `recent_emojis` cap (`MAX_RECENT_EMOJIS`) be configurable?** Currently hardcoded at 36. Could be promoted to a `GlyphieConfig` field.
